...
type RealworldClient interface {
	...
	AddCommentsToAnArticle(ctx context.Context, in *AddCommentsToanArticleRequest, opts ...grpc.CallOption) (*SingleCommentReply, error)
	GetCommentsFromAnArticle(ctx context.Context, in *GetCommentsFromanArticleRequest, opts ...grpc.CallOption) (*MultipleCommentsReply, error)
...
func (c *realworldClient) AddCommentsToAnArticle(ctx context.Context, in *AddCommentsToanArticleRequest, opts ...grpc.CallOption) (*SingleCommentReply, error) {
...
func (c *realworldClient) GetCommentsFromAnArticle(ctx context.Context, in *GetCommentsFromanArticleRequest, opts ...grpc.CallOption) (*MultipleCommentsReply, error) {
...
func (UnimplementedRealworldServer) AddCommentsToAnArticle(context.Context, *AddCommentsToanArticleRequest) (*SingleCommentReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddCommentsToAnArticle not implemented")
}
func (UnimplementedRealworldServer) GetCommentsFromAnArticle(context.Context, *GetCommentsFromanArticleRequest) (*MultipleCommentsReply, error) {
